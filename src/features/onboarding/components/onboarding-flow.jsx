...
export function OnboardingFlow() {
  ...
  const { control, register, setValue, getValues, trigger, formState: { errors } } = useForm({ defaultValues: savedData || onboardingDefaults, resolver: resolveOnboarding });
  ...
  const saveLater = () => { persist(); toast.success("Your onboarding progress has been saved."); };
  const goNext = async () => {
